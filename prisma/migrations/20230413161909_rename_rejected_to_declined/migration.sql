/*
  ...
  - The values [Rejected] on the enum `RunStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "RunStatus_new" AS ENUM ('Accepted', 'Declined', 'Backup', 'Bonus', 'Pending');
